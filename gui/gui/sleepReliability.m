...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fileName, pathName] = uigetfile({'*.mat'},'Primary Scorer');
set(handles.primaryFileIN, 'String', [pathName fileName]);
guidata(hObject,handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fileName, pathName] = uigetfile({'*.mat'},'Secondary Scorer');
set(handles.secondaryFileIN, 'String', [pathName fileName]);
guidata(hObject,handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
primaryScorer = load(get(handles.primaryFileIN,'string'));
secondaryScorer = load(get(handles.secondaryFileIN,'string'));
outPath = handles.folderOUTPath;
outName = get(handles.folderOUT,'string');

fun_scorer_reliability(primaryScorer, secondaryScorer,...
    'Report', 'on', 'SavePath', outPath, 'SaveName', outName);
